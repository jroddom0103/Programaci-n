...
public class UserService {
    ...
    public boolean checkLogin(String id, String pass){
        ...
        String contrasenaDescodificada = descodificar(pass);
        ...
        try {
            ...
            pst.setString(1, id);
            pst.setString(2, contrasenaDescodificada);
    ...
    public String consultarUsuario(String id){
        ...
        try {
            ...
            if (rs.next()){
                ...
                infoUser = correo+":"+codificar(contrasena)+":"+esAdmin;
            }
    ...
    public static String codificar(String contrasena){
        ...
        for (int i = 0; i<contrasena.length(); i++) {
            ...
            if(pos3 != -1){
                textoCodificado += numeros.charAt( (pos3 - 5) % numeros.length() );
                continue;
            }
