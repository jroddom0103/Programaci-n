...
import UD7.proyecto_UbriCines.services.impl.GestionFicheroUsuario;
import UD7.proyecto_UbriCines.services.impl.LoggerService;
...
public class ServiceUser implements BasicServiceUser{
    ...
    public boolean loginUI(String idUser, String passUser){
        ...
        return users.stream()
                .filter(usuario -> usuario.getId().equalsIgnoreCase(idUser) && usuario.getContrasena().equals(passUser))
                .findFirst()
                .isPresent();
    }
